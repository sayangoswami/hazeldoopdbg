...
public class UpdateIncomingInDHT {
    ...
    public static class GraphToDHTMap extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
        public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
            try {
                ...
                GraphLoader.updateIncoming(map, parts);
    ...
    public int run(String ip_path, String op_path) {
        ...
        try {
            ...
            conf.setJobName("UpdateIncomingInDHT");
    ...
    public static void main(String[] args) throws Exception {
        UpdateIncomingInDHT gtd = new UpdateIncomingInDHT();
